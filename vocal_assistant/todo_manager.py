...
class TodoManager:
    ...
    def handle_command(self, command):
        ...
        if label == 'add':
            ...
            self.speech_processor.speak("I don't understand your command. Please try again.")
    ...
    def add_to_todo_list(self, item):
        ...
        if todo:
            ...
            self.speech_processor.speak(f'Successfully added {todo} to your todo list!')
    ...
    def remove_from_todo_list(self, command):
        ...
        if task not in self.tasks:
            ...
            if decision == 'approve':
                ...
                self.speech_processor.speak(f"Okay! I won't remove the {task} from your to-do list.")